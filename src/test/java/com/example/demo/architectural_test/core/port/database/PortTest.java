package com.example.demo.architectural_test.core.port.database;
...
public class PortTest {
    ...
    @ArchTest
    static ArchRule class_port_must_be_package_port =
            ArchRuleDefinition.classes().that()
                    .haveSimpleNameEndingWith("Port")
                    .should()
                    .resideInAnyPackage(PackageEnum.PORT_DATABASE.getDescription());
